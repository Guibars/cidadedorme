...
export function MobileDayBreak() {
  ...
  return (
    <div className="flex-1 p-6 flex flex-col items-center justify-center text-center bg-[#141414] text-white select-none">
      ...
      <p className="text-base text-neutral-200 mt-3 max-w-xs leading-relaxed font-medium">
        Todos podem abrir os olhos e levantar a cabeça.
        <br />
